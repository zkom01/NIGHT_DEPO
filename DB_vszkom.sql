...
-- Vytvořeno: Stř 29. dub 2026, 23:31
-- Verze serveru: 8.4.7-7
-- Verze PHP: 8.3.26
...
(1, 1, 'IMG_69f2694fa51406.47275513.png');
...
CREATE TABLE `student` (
  ...
  `second_name` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `age` int NOT NULL,
  `life` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `user` (
  ...
  `heslo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `role` enum('user','admin','super_admin') COLLATE utf8mb4_general_ci DEFAULT 'user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
