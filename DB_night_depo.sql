...
-- Vytvořeno: Stř 22. dub 2026, 23:09
...
(14, 2, 'IMG_69e112fc1cf6b0.69945048.png'),
(15, 2, 'IMG_69e113341f8466.16896098.png'),
(18, 1, 'IMG_69e6a41c19f587.99367697.png');
...
CREATE TABLE `student` (
  ...
  `college_id` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Harry', 'Potter', 11, 'Chlapec, který přežil.', '5'),
(2, 'Hermiona', 'Grangerová', 12, 'Nejchytřejší čarodějka svého věku.', '5'),
...
(25, 'Blaise', 'Zabini', 124455, 'Elegantní student ze Zmijozelu.', '5'),
...
(61, 'Harry', 'EGRAD', 7454, 'fefes\\dfsv\\', '2');
...
(1, 'Eddie', 'Eddie', 'edzk@seznam.cz', '$2y$12$Ay2dBfh.QMfc5mRRj/MlQe0KLQ5oj9tt43Q1KU0JwNq3DU0jnPwTm', 'user'),
(2, 'Zdeněk', 'Komárek ', 'komarek.zdenek@seznam.cz', '$2y$12$0gjwGi5Hr2kTGDY7T0e1PeMxVr86F7RnXWU1arfllSi3T3rRPN5me', 'admin'),
(3, 'Eda', 'Potter', 'rr@rr.cz', '$2y$12$VNTF93DWrG4ES2hzurn36.RwMfKwIS7P/xrY/XYx9qgVKeA4ai.Vq', 'user'),
(5, 'e', 'e', 'e@e.cz', '$2y$12$YHmNQrs.OxhI2O44ZRePLeI97uTIUVWrYojFShg4yP5YRLgxXUq/q', 'user'),
(6, 'admin', 'admin', 'admin@admin.cz', '$2y$12$xOubLivfQIzLzkX.Ua0kwOJLJ8m5lb3pI815OjEd2OQuJuSntovgW', 'admin'),
(7, 'rrrr', 'Potter', 'tt@tt.cz', '$2y$12$/oNxdcIapg1uqGhSgrWrVu1r3DsbjEmRXkY.h84mKdhVVl/fMGRX.', 'user');
