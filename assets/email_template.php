...
<body style="margin: 0; padding: 0; background-color: rgba(0, 0, 0, 0.2); font-family: Arial, sans-serif;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #1a222b; padding: 20px;">
        <tr>
            <td align="center">
                <table width="100%" style="max-width: 600px; background-color: rgba(0, 0, 0, 0.2); border: 2px solid white; border-radius: 10px; overflow: hidden;" border="0" cellspacing="0" cellpadding="0">
                    
                    <tr>
                        <td style="padding: 20px; background-color: #0d3558; text-align: center;">
                            <h1 style="color: white; margin: 0; font-size: 24px; text-transform: uppercase;">Zpráva z night_depo</h1>
                        </td>
                    </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="10">
                                ...
                                <tr>
                                    <td style="padding-top: 20px;">
                                        ...
                                        <div style="margin-top: 10px; padding: 15px; background-color: rgba(0, 0, 0, 0.2); border: 1px solid white; border-radius: 6px; color: white; line-height: 1.5;">
                                            {{message}}
                                        </div>
                                    </td>
                                </tr>
